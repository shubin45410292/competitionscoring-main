//添加修改认定奖项弹窗_奖项认定信息管理页面(管理员端)

import 'package:flutter/material.dart';

class EditAwardDialog extends StatefulWidget {
  const EditAwardDialog({super.key});

  @override
  _EditAwardDialogState createState() => _EditAwardDialogState();
}

class _EditAwardDialogState extends State<EditAwardDialog> {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    OutlinedButton(
                      onPressed: _resetFields, // 点击重置时重置所有字段
