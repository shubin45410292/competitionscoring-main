              ...
              child: DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(color: Colors.grey.withOpacity(0.3), width: 0.8),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  ...
                  bottom: BorderSide(color: Colors.grey.withOpacity(0.3), width: 0.8), // 补充底部边框，样式统一
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Icon(Icons.cloud_upload_outlined, size: 32, color: Colors.blue[800]),


                        const SizedBox(height: 8),


                        const Text('拖拽文件至此处或点击', style: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w600)),
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          showDialog(
                            ...
                            builder: (context) => const AlertDialog(content: Text("提交中...")),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            ...
                            SnackBar(content: Text("申诉提交失败：${e.toString().substring(0, 50)}...")),
